...
ENDPOINT_MENU_MAP = {
    ...
    'aperturar_periodos_masivo_page': 'aperturar_periodos_masivo',
    'api_aperturar_periodos_masivo_listado': 'aperturar_periodos_masivo',
    'api_aperturar_periodos_masivo_aperturar': 'aperturar_periodos_masivo',
    'control_prestamos_page': 'control_prestamos',
    'reporte_prestamos_page': 'reporte_prestamos',
    'api_reporte_prestamos_detallado': 'reporte_prestamos',
    ...
    'plame_archivo14_masivo_page': 'plame_archivo_14_masivo',
    'plame_archivo15_page': 'plame_archivo_15',
    'plame_archivo15_masivo_page': 'plame_archivo_15_masivo',
    'plame_archivo18_page': 'plame_archivo_18',
    'plame_archivo18_masivo_page': 'plame_archivo_18_masivo',
    'plame_archivo26_page': 'plame_archivo_26',
    'plame_archivo26_masivo_page': 'plame_archivo_26_masivo',
    ...
    'reporte_planilla_todas_planillas_page': 'reporte_planilla_todas_planillas',
    'reporte_planilla_todas_planillas_post': 'reporte_planilla_todas_planillas',
...
PATH_PREFIX_MENU_MAP = {
    ...
    '/api/afp': 'afpnet',
    '/afp/': 'afpnet',
    '/api/declaracion-afp-masivo': 'afpnet_masivo',
    '/afp/declaracion-masivo': 'afpnet_masivo',
    '/api/aperturar-periodos-masivo': 'aperturar_periodos_masivo',
    '/aperturar-periodos-masivo': 'aperturar_periodos_masivo',
    '/api/reportes/prestamos-detallado': 'reporte_prestamos',
    '/reporte-prestamos': 'reporte_prestamos',
    '/control-prestamos': 'control_prestamos',
    '/api/prestamos': 'control_prestamos',
    '/api/plame/por-trabajador': 'plame_por_trabajador',
    '/plame/por-trabajador': 'plame_por_trabajador',
    '/api/plame/archivo-14-masivo': 'plame_archivo_14_masivo',
    '/plame/archivo-14-masivo': 'plame_archivo_14_masivo',
    '/api/plame/archivo-15-masivo': 'plame_archivo_15_masivo',
    '/plame/archivo-15-masivo': 'plame_archivo_15_masivo',
    '/api/plame/archivo-18-masivo': 'plame_archivo_18_masivo',
    '/plame/archivo-18-masivo': 'plame_archivo_18_masivo',
    '/api/plame/archivo-26-masivo': 'plame_archivo_26_masivo',
    '/plame/archivo-26-masivo': 'plame_archivo_26_masivo',
    '/plame/': 'plame_validar',
    ...
    '/reporte_planilla_todas_planillas': 'reporte_planilla_todas_planillas',
    '/reporte-planilla-todas-planillas': 'reporte_planilla_todas_planillas',
    '/api/selectores/procesos-todas-planillas': 'reporte_planilla_todas_planillas',
    '/api/selectores/periodos-todas-planillas': 'reporte_planilla_todas_planillas',
    '/api/reportes/lista-trabajadores': 'reporte_trabajadores',
    '/reporte-trabajadores': 'reporte_trabajadores',
    '/api/reportes/envio-boletas': 'reporte_envio_boletas',
    '/reporte-envio-boletas': 'reporte_envio_boletas',
