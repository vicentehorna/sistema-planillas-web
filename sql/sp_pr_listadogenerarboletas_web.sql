    ...
    WHERE PR_EmployeePayRoll.Company = @cia
      ...
      AND (
            NOT EXISTS (
                ...
                WHERE pt.ProcessType = @processtype
                  AND (
            ...
            OR EXISTS (
                ...
                WHERE vd.Company = PR_EmployeePayRoll.Company
                  AND vd.Person = PR_EmployeePayRoll.Person
                  AND LTRIM(RTRIM(vd.PRPeriod)) = LTRIM(RTRIM(@period))
