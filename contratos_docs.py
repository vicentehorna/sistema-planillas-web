...
def contexto_desde_fila(row: dict) -> dict:
    ...
    return {
        ...
        "inicio_contrato_anterior": _fmt_fecha_display(r.get("inicio_contrato_anterior")),
        "fin_contrato_anterior": _fmt_fecha_display(r.get("fin_contrato_anterior")),
...
MARCADORES_AYUDA = [
    ...
    ("inicio_contrato_anterior", "Inicio del contrato originario (prórroga)"),
    ("fin_contrato_anterior", "Fin del contrato originario (prórroga)"),
